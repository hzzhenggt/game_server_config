...
urlpatterns = [
    ...
    path('files/', views.server_file_list, name='server_file_list'),
    ...
    path('file/<int:pk>/compare/', views.server_file_compare, name='server_file_compare'),
    path('file/<int:pk>/delete/', views.ServerFileDeleteView.as_view(), name='server_file_delete'),
    # 历史记录
